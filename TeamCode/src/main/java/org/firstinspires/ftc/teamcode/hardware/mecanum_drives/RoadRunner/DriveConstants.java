...
public class DriveConstants {
     ...
     */
  /*  public static double WHEEL_RADIUS = 1.93; // in   // programming bot values
    ...
    public static double kV = 0.0189; // start with a value approximately 1.0 / rpmToVelocity(MAX_RPM)
    public static double kA = 0.00445;
    public static double kStatic = 0.005;
    /*
