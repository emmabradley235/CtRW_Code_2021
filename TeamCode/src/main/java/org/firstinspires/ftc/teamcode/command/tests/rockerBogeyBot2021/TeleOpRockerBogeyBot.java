package org.firstinspires.ftc.teamcode.command.tests.rockerBogeyBot2021;
...
@TeleOp(name = "TeleOp-Shoes", group = "@@@")
@Disabled

public class TeleOpRockerBogeyBot extends LinearOpMode{
    // TeleOp Variables

    // Robot Name - Feel free to set it to whatever suits your creative fancy :)
    String robotName = "INSERT_NAME_HERE";
    ...
    // Robot Classes
    private RockerBogeyBot robot; // Main robot data class (ALWAYS CREATE AN INSTANCE OF THIS CLASS FIRST - HARDWARE MAP SETUP IS DONE WITHIN)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot = new RockerBogeyBot(hardwareMap);
