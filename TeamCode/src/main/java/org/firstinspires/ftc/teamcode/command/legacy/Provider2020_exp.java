...
public class Provider2020_exp {
    ...
    // Robot State Objects
    private TrackingWheelLocalizer2020 odometry;
    ...
    private void init_map(HardwareMap hMap){    // setup the hardware map dependant classes (usually by grabbing their components out of the hardware map)
        ...
        */
        ...
        // setup odometry
        odometry = new TrackingWheelLocalizer2020(hMap);
    }
