package org.firstinspires.ftc.teamcode.hardware.mecanum_drives.legacy;

import com.qualcomm.robotcore.hardware.DcMotor;
import com.qualcomm.robotcore.util.ElapsedTime;


public class Drive_Mecanum_Tele_2020 {
    ...
    // Default constructor
    public Drive_Mecanum_Tele_2020(DcMotor driveMotorFL, DcMotor driveMotorFR, DcMotor driveMotorBL, DcMotor driveMotorBR){ // passing of individual motors in a constructor as an alternative to needing a robot class passed with the proper motor names
    ...
    public Drive_Mecanum_Tele_2020(DcMotor driveMotorFL, DcMotor driveMotorFR, DcMotor driveMotorBL, DcMotor driveMotorBR, double turnSpeed, double translateSpeed, double boostingSpeed){ // passing of individual motors in a constructor as an alternative to needing a robot class passed with the proper motor names
        localRuntime = new ElapsedTime();
