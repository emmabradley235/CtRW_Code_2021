...
public class DriveWheelTesting extends LinearOpMode{
    ...
    Drive_Mecanum_Tele_2020 mecanum_drive; // the main mecanum drive class
    ...
    public void runOpMode() throws InterruptedException {
        ...
        mecanum_drive = new Drive_Mecanum_Tele_2020(robot.driveFL, robot.driveFR, robot.driveBL, robot.driveBR, turnSpeed, translateSpeed, boostSpeed);
