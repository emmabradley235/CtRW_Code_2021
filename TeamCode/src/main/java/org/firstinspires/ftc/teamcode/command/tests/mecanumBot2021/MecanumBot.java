...
public class MecanumBot {
    ...
    public Servo duckSpinServo = null;
    ...
    Drive_Mecanum drive;
    ServoSpinner duckSpinner;


    // Default constructor
    public MecanumBot(HardwareMap hMap){
        ...
        duckSpinner = new ServoSpinner(duckSpinServo, 0.5, 1.0, 0.0);
    }
    public MecanumBot(HardwareMap hMap, String robotName){
